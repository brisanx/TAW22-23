...
<%
    List<CuentaBancariaDTO> cSospechosas = (List<CuentaBancariaDTO>) request.getAttribute("cSospechosas");
%>
<html>
<head>
...
<form:form action="/gestoria/sospechoso/agregar" modelAttribute="filtroA" method="post">
...
<form:form action="/gestoria/sospechoso/eliminar" modelAttribute="filtroE" method="post">
    <div class="form-group">
        <label for="id">Seleccione una cuenta:</label>
...
<table>
    ...
    <%
        if(!cSospechosas.isEmpty()){
            List<OperacionBancariaDTO> operaciones = (List<OperacionBancariaDTO>) request.getAttribute("opSospechosas");
    ...
    <tr>
        ...
        <td><a href="/gestoria/bloquear?id=<%=operaciones.get(i).getCuentaBancariaByIdCuentaOrigen().getId()%>">Eliminar</a></td>
    </tr>
