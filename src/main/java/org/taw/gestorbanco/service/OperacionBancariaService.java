...
public class OperacionBancariaService {
    ...
    public List<OperacionBancariaDTO> listarOperacionesClientes(List<Integer> asignaciones, opbFiltro filtro){

        List<OperacionBancariaEntity> operaciones =
                operacionBancariaRepository.operacionesPorAsignacion(asignaciones);
    ...
    private List<OperacionBancariaDTO> listaOperacionesADTO(List<OperacionBancariaEntity> operaciones) {
        ArrayList<OperacionBancariaDTO> dtos = new ArrayList<>();
