...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gestor_banco`.`usuario` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gestor_banco`.`divisa` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gestor_banco`.`cuenta_bancaria` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gestor_banco`.`empleado` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gestor_banco`.`operacion_bancaria` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gestor_banco`.`solicitud_activacion` ;
...
CREATE TABLE IF NOT EXISTS `gestor_banco`.`solicitud_activacion` (
  ...
  PRIMARY KEY (`id`),
  INDEX `id_cliente` (`id_usuario` ASC) VISIBLE,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gestor_banco`.`solicitud_alta` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gestor_banco`.`mensaje` ;

CREATE TABLE IF NOT EXISTS `gestor_banco`.`mensaje` (
  `id_mensaje` INT NOT NULL,
  `longitud` INT NULL,
  `texto` VARCHAR(45) NULL,
  `conversacion_id_conver` INT NOT NULL,
